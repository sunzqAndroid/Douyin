...
public class BottomNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            withicon = array.getBoolean(R.styleable.BottomNavigationView_bnv_with_icon, true);
...
//        }
     ...
     *
     * @param withicon disable or enable item incon
     */
    public void isWithIcon(boolean withicon) {
