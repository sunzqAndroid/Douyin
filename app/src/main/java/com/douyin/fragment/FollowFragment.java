...
import com.douyin.util.MyUtil;
import com.example.administrator.douyin.R;
import com.douyin.adapter.MainAdapter;
...
public class FollowFragment extends Fragment {
    ...
    private void initView() {
        rv_video = mRootView.findViewById(R.id.rv_video);
        rv_video.setLayoutManager(new LinearLayoutManager(mActivity));
        dataList = DataUtil.createData();
        MainAdapter adapter = new MainAdapter(mActivity, dataList);
        ...
        rv_video.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
                ...
                if (position != 0) {
                    outRect.top = (int) getResources().getDimension(R.dimen.devider_height);
                }
            }
        });
    ...
    MediaPlayerTool.VideoListener mVideoListener;
    //当前播放的视频角标
    ...
    private void playVideoByPosition(int resumePosition) {
        ...
        mVideoListener = new MediaPlayerTool.VideoListener() {
            @Override
            public void onStart() {
                vh.pb_video.setVisibility(View.GONE);
                //防止闪屏
        ...
        mMediaPlayerTool.setVideoListener(mVideoListener);
    ...
    public void onResume() {
        ...
        //检测是否继续播放视频
        if (jumpVideoPosition != -1 && dataList.get(jumpVideoPosition).getVideoUrl().equals(mMediaPlayerTool.mUrl) &&
